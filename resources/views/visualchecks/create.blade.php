...
<div class="row">
 <div class="col-md-12">
  ...
  <form method="post" action="{{url('visualchecks')}}">
   {{csrf_field()}}
   
   <div><H4 >  Add Visual Inspection Data </H4></div>

   <div align="middle">
   <a href="{{route('visualchecks.index')}}" class="btn btn-primary">View Inspection Data</a>
   <br />
   <br />
   <br />
  </div>
...
<div style="position: relative; left: 50px" class="form-group row">
  ...
  <table class="table">
    ...
    <tbody>
      ...
      <td><select class="form-control w-100" id="selectCategory" name="quality[]" required focus>
      <option value="" disabled selected>Select Yes/No</option>   
              <option value="Yes">Yes</option>  
              <option value="No">No</option>
      </td>
      <td><select class="form-control w-100" id="selectCategory" name="order_variety[]" required focus>
      <option value="" disabled selected>Select Yes/No</option>   
              <option value="Yes">Yes</option>  
              <option value="No">No</option>
      </td>
      <td><select class="form-control w-100" id="selectCategory" name="appearance[]" required focus>
      <option value="" disabled selected>Select Yes/No</option>   
              <option value="Yes">Yes</option>  
              <option value="No">No</option>
      </td>
      <td><select class="form-control w-100" id="selectCategory" name="batch[]" required focus>
      <option value="" disabled selected>Select Yes/No</option>   
              <option value="Yes">Yes</option>  
              <option value="No">No</option>
      </td>
      <td><select class="form-control w-100" id="selectCategory" name="sticker[]" required focus>
      <option value="" disabled selected>Select Yes/No</option>   
              <option value="Yes">Yes</option>  
              <option value="No">No</option>
      </td>
      <td><select class="form-control w-100" id="selectCategory" name="weight[]" required focus>
      <option value="" disabled selected>Select Yes/No</option>   
              <option value="Yes">Yes</option>  
              <option value="No">No</option>
      </td>
      <td><select class="form-control w-100" id="selectCategory" name="packaging[]" required focus>
      <option value="" disabled selected>Select Yes/No</option>   
              <option value="Yes">Yes</option>  
              <option value="No">No</option>
      </td>
