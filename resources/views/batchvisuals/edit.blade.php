...
<div class="row">
 <div class="col-md-12">
  ...
  @endif
  <form method="post" action="{{action('BatchCheckTomatoesController@update', $id)}}">
   {{csrf_field()}}
   ...
   <div class="form-group row">
    <label class="col-sm-2 col-form-label">Site Name</label>
      ...
      <option value="{{$batchvisuals->site_name}}" selected="selected">{{$batchvisuals->site_name}}</option>
  ...
  <div class="form-group row">
    <label class="col-sm-2 col-form-label">Date Added</label>
      <input class="form-control w-25"  type="date" name="date_added" class="form-control" id="dob" value="{{$batchvisuals->date_added}}"/>
  </div>
  <div class="form-group row">
    <label class="col-sm-2 col-form-label">Product Type</label>
      <select class="form-control w-25" id="selectCategory" name="product_type" required focus>
      <option value="{{$batchvisuals->product_type}}" selected="selected">{{$batchvisuals->product_type}}</option>
  ...
  <div class="form-group row">
    <label class="col-sm-2 col-form-label">Sample</label>
      ...
      <option value="{{$batchvisuals->sample}}" selected="selected">{{$batchvisuals->sample}}</option>   
  ...
  <div class="form-group row">
    <label class="col-sm-2 col-form-label">Batch code correct</label>
      <select class="form-control w-25" id="selectCategory" name="batch_code" required focus>
      <option value="{{$batchvisuals->batch_code}}" selected="selected">{{$batchvisuals->batch_code}}</option>   
      <option value="Yes">Yes</option>  
              <option value="No">No</option>
      </select>
  </div>
  <div class="form-group row">
    <label class="col-sm-2 col-form-label">Expiry date correct</label>
      <select class="form-control w-25" id="selectCategory" name="expiry_date" required focus>
      <option value="{{$batchvisuals->expiry_date}}" selected="selected">{{$batchvisuals->expiry_date}}</option>   
      <option value="Yes">Yes</option>  
              <option value="No">No</option>
      </select>
  </div>
