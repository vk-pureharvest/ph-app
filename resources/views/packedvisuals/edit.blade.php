...
<div class="row">
 <div class="col-md-12">
  ...
  @endif
  <form method="post" action="{{action('TomatoesPackedController@update', $id)}}">
   {{csrf_field()}}
   ...
   <div class="form-group row">
    <label class="col-sm-2 col-form-label">Site Name</label>
      ...
      <option value="{{$packedvisuals->site_name}}" selected="selected">{{$packedvisuals->site_name}}</option>
  ...
  <div class="form-group row">
    <label class="col-sm-2 col-form-label">Date Added</label>
      <input class="form-control w-25"  type="date" name="date_added" class="form-control" id="dob" value="{{$packedvisuals->date_added}}"/>
  </div>
  <div class="form-group row">
    <label class="col-sm-2 col-form-label">Product Type</label>
      <select class="form-control w-25" id="selectCategory" name="product_type" required focus>
      <option value="{{$packedvisuals->product_type}}" selected="selected">{{$packedvisuals->product_type}}</option>
  ...
  <div class="form-group row">
    <label class="col-sm-2 col-form-label">Sample</label>
      ...
      <option value="{{$packedvisuals->sample}}" selected="selected">{{$packedvisuals->sample}}</option>   
  ...
  <div class="form-group row">
    <label class="col-sm-2 col-form-label">Overall weight</label>
      <select class="form-control w-25" id="selectCategory" name="weight" required focus>
      <option value="{{$packedvisuals->weight}}" selected="selected">{{$packedvisuals->weight}}</option>   
      <option value="Yes">Yes</option>  
              <option value="No">No</option>
      </select>
  </div>
  <div class="form-group row">
    <label class="col-sm-2 col-form-label">Packing Quality</label>
      <select class="form-control w-25" id="selectCategory" name="quality" required focus>
      <option value="{{$packedvisuals->quality}}" selected="selected">{{$packedvisuals->quality}}</option>   
      <option value="Yes">Yes</option>  
              <option value="No">No</option>
      </select>
  </div>
  ...
  <div class="form-group row">
    <label class="col-sm-2 col-form-label">Packaging specs (batch code, expiry date etc)</label>
      <select class="form-control w-25" id="selectCategory" name="specs" required focus>
      <option value="{{$packedvisuals->specs}}" selected="selected">{{$packedvisuals->specs}}</option>   
      <option value="Yes">Yes</option>  
              <option value="No">No</option>
      </select>
  </div>   <br />
