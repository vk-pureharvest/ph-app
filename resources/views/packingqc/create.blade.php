...
<div class="row">
 <div class="col-md-12">
  ...
  <form method="post" action="{{url('packingqc')}}">
   {{csrf_field()}}
   
   <div><H4 >  Add Packing QC </H4></div>

   <div align="middle">
   <a href="{{route('packingqc.index')}}" class="btn btn-primary">View Packing QC</a>
   <br />
   <br />
   <br />
  </div>
...
<div style="position: relative; left: 50px" class="form-group row">
  ...
  <div style="position: relative; left: 50px" class="form-group row">
    ...
    <input class="form-control w-25" type="decimal" name="total_kg" placeholder="Enter Kg"/>
  </div>  
  <br />
  ...
  <table class="table">
    ...
    <tbody>
      <tr>
      <td><textarea  class="form-control" white-space="pre-wrap" type="text"  name="damage_reason[]" placeholder="Reason for Damage" cols="50" rows="1"></textarea></td>
      <td><input class="form-control" type="decimal" name="perc[]" class="form-control"  placeholder="Percentage"/></td> 
