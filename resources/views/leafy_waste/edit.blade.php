...
<div class="row">
 <div class="col-md-12">
  <br />
  <h3>Edit Leafy Greens Waste data</h3>
  <br />
  @if(count($errors) > 0)
  ...
  @endif
  <form method="post" action="{{action('Leafy_Waste_Controller@update', $id)}}">
   {{csrf_field()}}
   ...
   <div class="form-group row">
    <label class="col-sm-2 col-form-label">Site Name</label>
      ...
      <option value="{{$leafy_waste->site_name}}" selected="selected">{{$leafy_waste->site_name}}</option>
  ...
  <div class="form-group row">
    <label class="col-sm-2 col-form-label">Date Added</label>
      <input class="form-control w-25"  type="date" name="date_added" class="form-control" id="dob" value="{{$leafy_waste->date_added}}"/>
  </div>
  
  <div class="form-group row">
    <label class="col-sm-2 col-form-label">Product Type</label>
    <select class="form-control w-25" id="selectProduct" name="product_type" required focus>
                <option value="{{$leafy_waste->product_type}}" selected="selected">{{$leafy_waste->product_type}}</option>  
   ...
   <div class="form-group row">
    <label class="col-sm-2 col-form-label">Total Waste (KGs)</label>
    <input class="form-control w-25" type="decimal" name="total_kgs" class="form-control" value="{{$leafy_waste->total_kgs}}" />
   </div>

   <div class="form-group row">
    <label class="col-sm-2 col-form-label">Comments</label>
      <input class="form-control w-25"  type="text" name="comments" class="form-control" value="{{$leafy_waste->comments}}"/>
  </div>
