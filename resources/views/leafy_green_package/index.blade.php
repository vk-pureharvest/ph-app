...
<div class="row" padding="10px 20px 10px 200px">
 <div class="col-md-12">
  <br />
  <h3 align="center">Leafy Greens Packaging Data</h3>
  <br />
  ...
  @endif
  <div align="right">
   <a href="{{route('leafy_green_package.create')}}" class="btn btn-primary">Add Leafy Greens Packaging Data</a>
   <br />
   <br />
  </div>
  <table class="table table-bordered table-striped">
   ...
   @foreach($leafy_green_package as $row)
   <tr>
    <td>{{$row['site_name']}}</td>
