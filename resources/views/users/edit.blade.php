      ...
      <form method="post" action="{{ route('users.update', $user->id) }}">
        ...
        @method('PUT')
         ...
         <div style="position: relative; left: 50px" class="form-group row">
            ...
            <input class="form-control w-25" type="text" name="name" value="{{ $user->name }}" class="form-control" id="name"  placeholder="Enter Name"/>
         </div>
         <div style="position: relative; left: 50px" class="form-group row">
            <label class="col-sm-2 col-form-label">Email</label>
            <input class="form-control w-25" type="email" name="email" value="{{ $user->email }}" class="form-control" id="email"  placeholder="Enter Email"/>
         </div>
         <div style="position: relative; left: 50px" class="form-group row">
         ...
         <div class="form-group w-25">
            <input style="position: relative; left: 250px" type="submit" value="Update User" class="btn btn-primary" />
      </form>
      </div>
      </form>
   </div>
