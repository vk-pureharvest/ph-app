...
<div class="row">
 <div class="col-md-12">
  ...
  <form method="post" action="{{url('substrate_datas')}}">
   {{csrf_field()}}
   
   <div><H4 >  Add Substrate Data </H4></div>

   <div align="middle">
   <a href="{{route('substrate_datas.index')}}" class="btn btn-primary">View History</a>
   <br />
   <br />
   <br />
  </div>
...
<div style="position: relative; left: 50px" class="form-group row">
  ...
  <div style="position: relative; left: 50px" class="form-group row">
    <label class="col-sm-2 col-form-label">Compartment</label>
      <select class="form-control w-25" id="selectCategory" name="compartment" required focus>
        <option value="CMP 1" selected>CMP 1</option>        
  ...
  <table class="table">
    ...
    <tbody>
      ...
      <tr>
      <td><input type="text" name="metric[]" class="form-control" value="O2"/></td>
      <td><input type="decimal" name="pl_1[]" class="form-control" /></td>
      <td><input type="decimal" name="pl_2[]" class="form-control" /></td>
      <td><input type="decimal" name="pl_3[]" class="form-control" /></td>
        <td><a href="javascript:;" class="btn btn-danger deleteRow">-</a></td>
      ...
      <tr>
      <td><input type="text" name="metric[]" class="form-control" value="Root Health"/></td>
      <td><input type="decimal" name="pl_1[]" class="form-control" /></td>
      <td><input type="decimal" name="pl_2[]" class="form-control" /></td>
      <td><input type="decimal" name="pl_3[]" class="form-control" /></td>
        <td><a href="javascript:;" class="btn btn-danger deleteRow">-</a></td>
