...
class ShelfLifeTest extends Model
{
   ...
   public static function getShelfLifeTest(){
       $records = DB::table('shelf_life_tests')->select("site_name","testing_date", "day_of_testing","date_harvested","product_type","color_L","color_A","color_B","color_rank","BRIX","firmness","firmness_rank","smell_rank","weight","weight_rank","wrinkles","height","width","vine_quality","spots","fungus","quality_rank","remarks")->orderBy('product_type','day_of_testing','desc')->get()->toArray();
       return $records; 
   }
