...
class ProductionsKSAController extends Controller
{
    /**
    ...
    {
        return view('productions_ksa.create');
    }
    ...
    public function store(Request $request)
    {
       ...
       return redirect()->route('productions_ksa.create')->with('success', 'Data Added');
    }
    ...
    public function show($id)
    {
        ...
        return view('productions_ksa.edit', compact('productions', 'id'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $productions->save();
        return redirect()->route('productions_ksa.index')->with('success', 'Data Updated');
    }
    ...
    public function destroy($id)
    {
        $productions = Production::find($id);
        $productions->delete();
        return redirect()->route('productions_ksa.index')->with('success', 'Data Deleted');
    }
}
